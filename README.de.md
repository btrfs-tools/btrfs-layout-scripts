...
- Bricht sofort ab, wenn `/` bereits von einem benannten Subvolume läuft oder einer der Zielpfade schon separat gemountet ist — Anzeichen für eine bereits (teilweise) durchgeführte Migration, bei der ein erneuter Lauf mehr schaden als nützen würde.
